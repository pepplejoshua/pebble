...
| Slicing a wrapped array parameter inside a helper | n/a | invalid C — array typedef used as slice base instead of `.data` | Confirmed present, found during task #86 slice 86d, queued as task #101, not yet fixed |
