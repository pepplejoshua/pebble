...
| Anonymous `.{ ... }` struct construction (no base type name) | n/a | checker gap, found 2026-08-12 during Phase 3 #4, unrelated to arrays | **Partial/broken** — fails with a missing Field symbol (C0619); member symbols never resolve for the base-less literal form. Pre-existing, general, not array-specific |
