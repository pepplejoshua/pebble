...
func validNode(t *testing.T, b *Builder, kind NodeKind, refs map[NodeID]struct{}, sharedTemp TempID) Node {
	...
	case SliceFromRaw:
		return Node{Kind: kind, Type: intType, Span: span, Children: []NodeID{ensureChild(IntegerLiteral), ensureChild(IntegerLiteral)}}
	case StoragePlace:
		return Node{Kind: kind, Type: intType, Span: span, Symbol: 1}
	...
	case VariantConstruct:
		return Node{Kind: kind, Type: intType, Span: span, Member: 1}
	case IntegerCast, IntegerToFloat, FloatToInteger, FloatCast, OptionalInject, EnumToInteger, CharToInteger, IntegerToChar, OptionalIntegerToEnum, CheckedIntegerToEnum, PointerCast, PointerToInteger:
