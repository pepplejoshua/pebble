...
AstNode *ast_func_decl(Location loc, const char *name, FuncParam *params,
...
AstNode *ast_var_decl(Location loc, const char *name, AstNode *type_expr,
                      AstNode *init) {
...
AstNode *ast_const_decl(Location loc, const char *name, AstNode *type_expr,
                        AstNode *value) {
...
// Binary operation
AstNode *ast_binary_op(Location loc, BinaryOp op, AstNode *left,
                       AstNode *right) {
...
// Function call
AstNode *ast_func_call(Location loc, AstNode *func, AstNode **args,
                       size_t arg_count) {
